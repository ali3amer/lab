        ...
        <form class="w-full" wire:submit="save()">
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="expenseDate">
                        التاريخ
                    </label>
                    <input autocomplete="off" required
                        ...
                        <tr class="border-b-2">
                            ...
                            <td>
                                ...
                                <button class="bg-red-400 p-2 rounded text-xs text-white"
                                        wire:click="deleteExpenseMessage({{$expense->id}})"><i class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    @endforeach
