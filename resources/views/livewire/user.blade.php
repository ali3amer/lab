<div class="">
    ...
    <div class="flex">
        @if($user->hasPermission("users-create") || $user->hasPermission("users-update"))
                                    ...
                                    <td>
                                        @if($user->hasPermission("users-update"))
                                            <button class="bg-cyan-400 p-2 rounded text-xs text-white"
                                                    wire:click="editUser({{$item}})"><i class="fa fa-pen"></i></button>
                                        @endif
                                        @if($user->hasPermission("users-delete"))
                                            <button
                                                @disabled(auth()->user()->id == $item->id) class="bg-red-400 p-2 rounded text-xs text-white"
                                                wire:click="deleteMessage({{$item->id}})"><i class="fa fa-trash"></i>
                                            </button>
                                        @endif
                                    </td>
                                </tr>
