<div class="">
    ...
    @if(empty($currentEmployee))
        @if($user->hasPermission("employees-create") || $user->hasPermission("employees-update"))
                                    ...
                                    <td>
                                        ...
                                        @if($user->hasPermission("employees-delete"))
                                            <button class="bg-red-400 p-2 rounded text-xs text-white"
                                                    wire:click="deleteEmployeeMessage({{$employee->id}})"><i
                                                    class="fa fa-trash"></i>
                                            </button>
                                        @endif
                                        @if($user->hasPermission("employees-read"))
                            ...
                            @foreach($expenses as $expense)
                                <tr class="border-b-2">
                                    ...
                                    <td>
                                        @if($user->hasPermission("employees-update"))
                                            <button class="bg-cyan-400 p-2 rounded text-xs text-white"
                                                    wire:click="editExpense({{$expense}})"><i class="fa fa-pen"></i>
                                            </button>
                                        @endif
                                        @if($user->hasPermission("employees-delete"))
                                            <button class="bg-red-400 p-2 rounded text-xs text-white"
                                                    wire:click="deleteEmployeeExpenseMessage({{$expense->id}})"><i
                                                    class="fa fa-trash"></i>
                                            </button>
                                        @endif
                                    </td>
